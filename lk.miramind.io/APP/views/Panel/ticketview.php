...
<p><button class="btn btn-primary" onclick="post_ticket_answer()" >Написать ответ</button> | <button class="btn btn-success" onclick="post_close_ticket()" >Закрыть тикет</button> | <button class="btn btn-danger" onclick="history.back();return false;" >Назад</button></p>
  </div>
